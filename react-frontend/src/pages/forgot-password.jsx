  ...
  return (
    ...
    <div className="auth-shell">
      <div className="auth-brand">
        ...
        <div className="quote">
          "Forgot my password twice this year. Both times I was back in within a minute."
          <div className="quote-who">— Community feedback survey, 2026</div>
        </div>
      </div>
      <div className="auth-form-side">
        <div className="auth-card">
          ...
          <p className="muted" style={{marginBottom: "1.6rem"}}>Enter the email on your account and we'll send a link to reset it.</p>
